...
public class Hospede {
    ...
    // Construtor sem idHospedes (para criação de novos hóspedes)
    public Hospede(String nomeCompleto, Date dtNascimento, String endereco, String telefone, String email, String cpf) {
        this.nomeCompleto = nomeCompleto;
        this.dtNascimento = dtNascimento;
        this.endereco = endereco;
        this.telefone = telefone;
